...
exports.resetPasswordForm = function (req, res) {
    res.render('change_pw/change_pw', {title: 'Reset Password'});
};
...
exports.updatePasswordForm = function (req, res) {
    ...
    res.render('account/forms/password', {title: 'Edit Password', breadcrumbs: breadcrumbs});
};
...
exports.register = function (req, res) {
    ...
    User.findOne({email: req.body.email}, function (err, user) {
        ...
        if (user == null ){
            ...
            res.writeHead(302, {'Location': '/register_again/'});
            res.end();
        }
    });
};
...
exports.registerErrorForm = function (req, res) {
    res.render('register_again/register_again', {title: 'Registration'});
};
...
exports.restorePasswordForm = function (req, res) {
    res.render('restore_password/restore_password', {title: 'Restore Password'});
};

exports.restorePasswordErrorForm = function (req, res) {
    res.render('restore_again/restore_again', {title: 'Restore Password'});
};
...
exports.sendEmail = function (req, res) {
    ...
    User.findOne({email: req.body.email}, function (err, user) {
        if (!err && user){
            ...
            res.writeHead(302, {'Location': '/restore_again'});
            res.end();
        }
    });
};
