...
exports.createForm = function (req, res) {
    ...
    res.render('categories/forms/create', {title: 'Create Category', breadcrumbs: breadcrumbs});
};
...
exports.get = function (req, res) {
    ...
    Category.find({}, function(err, categories) {
        ...
        res.render('categories/list', {title: 'Categories', categories: categories, breadcrumbs: breadcrumbs});
    });
...
exports.delete = function (req, res) {
    Category.findOne({_id: req.query._id}, function (err, category) {
        if(err){console.log(err);}
        Product.find({category: category.identity}, function (err, products) {
            if(err){console.log(err);}
...
exports.create = function (req, res) {
    ...
    Category.findOne({identity: req.body.identity}, function (err, found) {
        if (found == null) {
            ...
            newCategory.save( function (err, category) {
                ...
                newCategory.save_image(req.files.logo, function (err) {
                    if (err) {
                        ...
                        res.render('categories/forms/create', {title: 'Create Category', breadcrumbs: breadcrumbs, error: error });
                    }else {
                        res.redirect("/categories");
                    }
                })
...
exports.updateForm = function (req, res) {
    ...
    Category.findOne({_id: req.query._id}, function (err, category) {
        if(err){console.log(err);}
        res.render('categories/forms/edit', {title: 'Edit Category', category: category, breadcrumbs: breadcrumbs});
    });
};
